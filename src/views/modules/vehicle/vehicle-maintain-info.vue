  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      ...
      <el-form-item label="初审备注" prop="firstRemark">
        <el-input v-model="dataForm.firstRemark" placeholder="初审备注" :disabled="true"></el-input>
      </el-form-item>
      <el-form-item label="终审备注" prop="lastRemark">
        <el-input v-model="dataForm.lastRemark" placeholder="终审备注" :disabled="true"></el-input>
      </el-form-item>
