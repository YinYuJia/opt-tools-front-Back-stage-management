  ...
  <main class="site-content " :class="{ 'site-content--tabs': $route.meta.isTab }"  >
    ...
    <el-tabs
      ...
      <el-dropdown class="site-tabs__tools" :show-timeout="0" >
        <i class="el-icon-arrow-down el-icon--right" :style="{ 'margin-let':(width)+'px'}"></i>
    ...
    <!-- 主入口标签页 e -->
    <el-card v-else :body-style="siteContentViewHeight" id="system">
      <keep-alive>
        <router-view  />
      </keep-alive>
    </el-card>
  ...
  export default {
    ...
    computed: {
      ...
      siteContentViewHeight () {
        ...
        return { minHeight: height + 'px',padding:0 + 'px' }
      }
    },
    methods: {
      // 动态left
