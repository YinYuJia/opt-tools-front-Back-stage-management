...
<!--          </el-form-item>-->
          <el-form-item label="确认备注" prop="confirmRemark">
            <el-input v-model="dataForm.confirmRemark" />
          </el-form-item>
        </el-form>
      </el-tab-pane>
    </el-tabs>
    ...
    <span v-if="showApproval" slot="footer" class="dialog-footer">
      <el-button type="primary" @click="approvalStatus(4)">确认信息</el-button>
    </span>
  </el-dialog>
</template>
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        planArrivalTime: [
          { required: true, message: "预计到货不能为空", trigger: "blur" }
        ],
        planInvoiceTime: [
          {
            required: true,
            message: "预计发票到达时间不能为空",
            trigger: "blur"
          }
        ],
      }
        ...
        if (valid) {
          ...
          this.$http({
            ...
            data: this.$http.adornData({
              ...
              confirmRemark: this.dataForm.confirmRemark,
              planInvoiceTime: this.dataForm.planInvoiceTime,
              planArrivalTime: this.dataForm.planArrivalTime,
