<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      ...
      <el-form-item label="用车事由" prop="reason">
        <el-input v-model="dataForm.reason" placeholder="用车事由" :disabled="true"></el-input>
      </el-form-item>
      <el-form-item label="申请描述" prop="vehicleApplyId">
        <!-- <el-input v-model="dataForm.vehicleApplyId" placeholder="车辆申请单ID"></el-input> -->
        <el-select style="width: 100%"  v-model="dataForm.vehicleApplyId" placeholder="请选择" :disabled="true" >
          <el-option v-for="item in vehicleApplication" :key="item.key" :label="item.label" :value="item.value"/>
        </el-select>
      </el-form-item>
  ...
  <!-- ---------------------------------- 静态框 监听车辆申请单ID变化---------------------------------------------  -->
      ...
      <el-form-item label="起始公里表数" prop="startNumber">
        <el-input v-model="dataForm.startNumber" placeholder="起始公里表数" :disabled="true"></el-input>
      </el-form-item>
        </el-col>
        <el-col :span="12">
      <el-form-item label="返回公里表数" prop="endNumber">
        <el-input v-model="dataForm.endNumber" placeholder="返回公里表数" :disabled="true"></el-input>
      </el-form-item>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-form-item label="高速费用" prop="highCost">
        <el-input v-model="dataForm.highCost" placeholder="高速费用" :disabled="true"></el-input>
      </el-form-item>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-form-item label="停车费用" prop="topCost">
        <el-input v-model="dataForm.topCost" placeholder="停车费用" :disabled="true"></el-input>
      </el-form-item>
        </el-col>
        <el-col :span="12">
      <el-form-item label="加油费用" prop="oilCost">
        <el-input v-model="dataForm.oilCost" placeholder="加油费用" :disabled="true"></el-input>
      </el-form-item>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-form-item label="其他费用" prop="otherCost">
        <el-input v-model="dataForm.otherCost" placeholder="其他费用" :disabled="true"></el-input>
      </el-form-item>
        </el-col>
        <el-col :span="12">
      <el-form-item label="加油时剩余油量" prop="surplus">
        <el-input v-model="dataForm.surplus" placeholder="加油时剩余油量" :disabled="true"></el-input>
      </el-form-item>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-form-item label="加油量" prop="fuelAmount">
        <el-input v-model="dataForm.fuelAmount" placeholder="加油量" :disabled="true"></el-input>
      </el-form-item>
        </el-col>
        <el-col :span="12">
      <el-form-item label="油卡余额" prop="oilCardBalance">
        <el-input v-model="dataForm.oilCardBalance" placeholder="油卡余额" :disabled="true"></el-input>
      </el-form-item>
        </el-col>
      </el-row>
      <el-form-item label="现金加油" prop="cash">
        <el-input v-model="dataForm.cash" placeholder="现金加油" :disabled="true"></el-input>
      </el-form-item>
          ...
          if (this.dataForm.vehicleTravelId) {
            API.oavehicletravel.info(this.dataForm.vehicleTravelId).then(({data}) => {
              if (data && data.code === 0) {
                ...
                // this.dataForm.driverMileage = data.oaVehicleTravel.driverMileage
