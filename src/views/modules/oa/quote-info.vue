  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      <el-form-item label="甲方" prop="partya">
        <el-input v-model="dataForm.partya" placeholder="甲方" :disabled="true"></el-input>
      </el-form-item>
      <el-form-item label="乙方" prop="partyb">
        <el-input :disabled="true" v-model="dataForm.partyb" placeholder="乙方" ></el-input>
      </el-form-item>
      <el-form-item label="项目名称" prop="quoteName">
        <el-input v-model="dataForm.quoteName" placeholder="项目名称" :disabled="true"></el-input>
      </el-form-item>
      <el-form-item label="项目要求与功能" prop="quoteRequire">
        <el-input v-model="dataForm.quoteRequire" placeholder="项目要求与功能" :disabled="true"></el-input>
      </el-form-item>
      <el-form-item label="利润率" prop="rate">
        <el-input v-model="dataForm.rate" @input="getTimes" type="tel"  step="10" placeholder="利润率" :disabled="true"></el-input>
      </el-form-item>
      <el-row>
        <el-col :span="12">
        ...
        >
          ...
          <el-table-column prop="mainFunc" header-align="center" align="center" label="主要功能">
            <template slot-scope="scope">
              <el-input size="small" placeholder="请输入主要功能" v-model="scope.row.mainFunc" :disabled="true">
              </el-input>
            </template>
          </el-table-column>
          <el-table-column prop="funcAnaly" header-align="center" align="center" label="功能分析">
            <template slot-scope="scope">
              <el-input size="small" placeholder="请输入功能分析" v-model="scope.row.funcAnaly" :disabled="true">
              </el-input>
            </template>
          </el-table-column>
          <el-table-column prop="engineerConf" header-align="center" align="center" label="工程师配置">
            <template slot-scope="scope">
              <el-select v-model="scope.row.engineerConf" placeholder="请选择工程师配置" :disabled="true">
          ...
          <el-table-column prop="unitPrice" header-align="center" align="center" label="单价">
            <template slot-scope="scope">
              <el-select @change="computed" v-model="scope.row.unitPrice" placeholder="请选择单价" :disabled="true">
          ...
          <el-table-column prop="actualWorkload" header-align="center" align="center" label="实际工作量">
            <template slot-scope="scope">
              <el-input size="small" @input="computed" :disabled="true" placeholder="请输入实际工作量" v-model="scope.row.actualWorkload">
              </el-input>
            </template>
          </el-table-column>
          <el-table-column prop="actualAmount" header-align="center" align="center" label="实际金额">
            <template slot-scope="scope">
              <el-input :disabled="true" size="small" placeholder="请输入实际金额" v-model="scope.row.actualAmount">
              </el-input>
            </template>
          </el-table-column>
          <el-table-column prop="workload" header-align="center" align="center" label="报价工作量">
            <template slot-scope="scope">
              <el-input  size="small" placeholder="请输入报价工作量" v-model="scope.row.workload" :disabled="true">
              </el-input>
            </template>
          </el-table-column>
          <el-table-column prop="amount" header-align="center" align="center" label="报价金额">
            <template slot-scope="scope">
              <el-input  size="small" placeholder="请输入报价金额" v-model="scope.row.amount" :disabled="true">
              </el-input>
            </template>
          </el-table-column>
        </el-table>
